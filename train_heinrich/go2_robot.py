...
from train_heinrich.heinrich_isaac_gym_config import LeggedRobotCfg
...
class LeggedRobot(BaseTask):
    ...
    def _push_robots(self):
        ...
        push_env_ids = env_ids[
            self.episode_length_buf[env_ids] % int(self.cfg.domain_rand.push_interval)
            == 0
        ]
    ...
    def _get_noise_scale_vec(self, cfg):
        ...
        noise_vec[
            12 + 2 * self.num_actions : 12 + 3 * self.num_actions
